...
class SeeStockOrSaveButtonComponent extends StatefulWidget {
  ...
  SeeStockOrSaveButtonComponent({super.key, required this.food, required this.seeHistory, required this.addValue, required this.haveSeeHistory});

  @override
  State<SeeStockOrSaveButtonComponent> createState() => _SeeStockOrSaveButtonComponentState();
}

class _SeeStockOrSaveButtonComponentState extends State<SeeStockOrSaveButtonComponent> {
  @override
