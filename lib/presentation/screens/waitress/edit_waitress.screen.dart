                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: Style.interBold(
                                  size: 26.sp, color: Style.darker),
                            ),
                            12.verticalSpace,
                            Text(
                              "Sexe",
                              style: Style.interBold(
                                  size: 16.sp, color: Style.darker),
                            ),
                            4.verticalSpace,
                            Row(
                              children: [
                                GenderSelectionComponent(
                                    ...
                                    isSelected:
                                        _waitressController.selectedGender ==
                                            'MALE'),
                            ...
                            textField("Nom", null, "Nom complet du serveur",
                                initialValue:
                                    waitressController.waitressName.text),
                            330.verticalSpace,
                            Container(
                              height: 55.h,
                              ...
                              child: CustomButton(
                                isLoading:
                                    waitressController.isLoadingCreateWaitress,
