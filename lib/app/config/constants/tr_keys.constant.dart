class TrKeysConstant {
  TrKeysConstant._();
  // static const String welcomeText = "Prise de commande, gestion de stock et gestion financière simplifiée de votre établissement.";
  ...
  // static const String fcfa = 'F CFA';
